...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Jornadasgrup'), ['action' => 'edit', $jornadasgrup->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Jornadasgrup'), ['action' => 'delete', $jornadasgrup->id], ['confirm' => __('Are you sure you want to delete # {0}?', $jornadasgrup->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Jornadasgrups'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Jornadasgrup'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column column-80">
        <div class="jornadasgrups view content">
            <h3><?= h($jornadasgrup->codigo) ?></h3>
            <table>
                <tr>
                    <th><?= __('Codigo') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($jornadasgrup->activitatsgrups)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($jornadasgrup->activitatsgrups as $activitatsgrup) : ?>
                        <tr>
