 ...
 * @var string[]|\Cake\Collection\CollectionInterface $agentes
 * @var string[]|\Cake\Collection\CollectionInterface $empresas
 * @var string[]|\Cake\Collection\CollectionInterface $empresados
 * @var string[]|\Cake\Collection\CollectionInterface $empresatres
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $comercial->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="comercials form content">
            ...
            <fieldset>
                <legend><?= __('Edit Comercial') ?></legend>
                <?php
