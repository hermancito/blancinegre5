 ...
 * @var string[]|\Cake\Collection\CollectionInterface $user2s
 * @var string[]|\Cake\Collection\CollectionInterface $colegs
    ...
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $alumno->id), 'class' => 'side-nav-item']
            ) ?>
