 ...
 * @var iterable<\App\Model\Entity\Activitat> $activitats
 */
?>
<div class="activitats index content">
    <?= $this->Html->link(__('New Activitat'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Activitats') ?></h3>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $activitat->id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $activitat->id]) ?>
                        <?= $this->Form->postLink(
                            __('Delete'),
