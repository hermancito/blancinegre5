...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Activitats Monitor'), ['action' => 'edit', $activitatsMonitor->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Activitats Monitor'), ['action' => 'delete', $activitatsMonitor->id], ['confirm' => __('Are you sure you want to delete # {0}?', $activitatsMonitor->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Activitats Monitors'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Activitats Monitor'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column column-80">
        <div class="activitatsMonitors view content">
            <h3><?= h($activitatsMonitor->id) ?></h3>
            <table>
                <tr>
                    <th><?= __('Activitat') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($activitatsMonitor->activitatsgrups)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($activitatsMonitor->activitatsgrups as $activitatsgrup) : ?>
                        <tr>
